...
.onLoad = function(lib, pkg) {
  ...
  mybnlearn.classes = c("bn", "bn.fit", available.classifiers)
  ...
  # make mybnlearn's classes known to S4.
  setClass("bn")
  setClass("bn.fit")
  setClass("bn.naive")
  setClass("bn.tan")
  ...
  library.dynam("mybnlearn", package = pkg, lib.loc = lib)
...
.onUnload = function(libpath) {
  ...
  library.dynam.unload("mybnlearn", libpath = libpath)
